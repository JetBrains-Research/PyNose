...
class ObscureInLineSetupTestSmellUnittestInspectionTests : AbstractTestSmellInspectionTestWithSdk() {
    ...
    override fun setUp() {
        ...
        myFixture.enableInspections(ObscureInLineSetupTestSmellUnittestInspection())
    }

    override fun getTestDataPath(): String {
        return "src/test/resources/org/jetbrains/research/pynose/plugin/inspections/data/obscure/unittest"
    }
